...
[![GH-actions Windows](https://github.com/pachadotdev/gravity/workflows/check-windows/badge.svg)](https://github.com/pachadotdev/gravity/actions)
[![GH-actions Linux](https://github.com/pachadotdev/gravity/workflows/check-linux/badge.svg)](https://github.com/pachadotdev/gravity/actions)
[![CRAN status](https://www.r-pkg.org/badges/version/gravity)](https://cran.r-project.org/package=gravity)
[![Coverage status](https://codecov.io/gh/pachadotdev/gravity/branch/master/graph/badge.svg)](https://codecov.io/github/pachadotdev/gravity?branch=master)
